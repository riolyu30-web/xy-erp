...
def find_client(access_token: str,customerId:str=None) -> str:  # 定义工具函数
    ...
    # 调用通用工具方法获取并过滤数据
    return fetch_data("客户表", function_name, data, access_token, filtered_fields, meaning_list)  # 返回数据  
...
def find_contract(access_token: str) -> str:  # 定义工具函数
    ...
    # 调用通用工具方法获取并过滤数据
    return fetch_data("合同表", function_name, data, access_token, filtered_fields, meaning_list)  # 返回数据  
...
def find_biz_order(access_token: str) -> str:  # 定义工具函数
    ...
    # 调用通用工具方法获取并过滤数据
    return fetch_data("订单表", function_name, data, access_token, filtered_fields, meaning_list)  # 返回数据  
...
def get_source(access_token: str) -> str:  # 定义工具函数
    ...
    # 调用通用工具方法获取并过滤数据
    return fetch_data("关联表", function_name, data, access_token, filtered_fields, meaning_list)  # 返回数据  
