...
import json  # 导入JSON库
outgoing_mcp = FastMCP(name="outgoing")  # 创建计算服务MCP实例


@outgoing_mcp.tool()  # 注册工具
def OUTGOING_ORDER_DETAIL(access_token: str,outgoingOrderDetailFromCreateTime:str=None,outgoingOrderDetailToCreateTime:str=None) -> str:  # 定义工具函数
    """
    外发订单明细表，发外加工
    ...
    Args:
        ...
        outgoingOrderDetailFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        outgoingOrderDetailToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
...
def MAT_ARR_DET(access_token: str,matArrDetFromCreateTime:str=None,matArrDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        matArrDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        matArrDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
...
def MANU_STATEMENT_DET(access_token: str,manuStatementDetFromCreateTime:str=None,manuStatementDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        manuStatementDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        manuStatementDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
