...
import json  # 导入JSON库
pay_mcp = FastMCP(name="pay")  # 创建计算服务MCP实例


@pay_mcp.tool()  # 注册工具
def REC_SETTLE_DET(access_token: str,recSettleDetFromCreateTime:str=None,recSettleDetToCreateTime:str=None) -> str:  # 定义工具函数
    """
    应收结算明细，收款查询
    ...
    Args:
        ...
        recSettleDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        recSettleDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S 
...
def PAY_SETTLE_DET(access_token: str,paySettleDetFromCreateTime:str=None,paySettleDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        paySettleDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        paySettleDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
...
def RECEIVABLE_DET(access_token: str,receivableDetFromCreateTime:str=None,receivableDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        receivableDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        receivableDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
...
def PAYABLE_DET(access_token: str,payableDetFromCreateTime:str=None,payableDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        payableDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        payableDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
