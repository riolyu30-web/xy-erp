...
import json  # 导入JSON库
work_mcp = FastMCP(name="work")  # 创建计算服务MCP实例


@work_mcp.tool()  # 注册工具
def PROD_PRCES_APPLY_DET(access_token: str,prodPrcesApplyDetFromCreateTime:str=None,prodPrcesApplyDetToCreateTime:str=None) -> str:  # 定义工具函数
    """
    生产加工申请明细，补单
    ...
    Args:
        ...
        prodPrcesApplyDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        prodPrcesApplyDetToCreateTime: 结束时间，格式为YYYY-%m-DD %H:%M:%S
...
def MAT_OUT_APY_DET(access_token: str,matOutApyDetFromCreateTime:str=None,matOutApyDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        matOutApyDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        matOutApyDetToCreateTime: 束时间，格式为YYYY-%m-DD %H:%M:%S
...
def SAM_ORDER_NOTICE_DET(access_token: str,samOrderNoticeDetFromCreateTime:str=None,samOrderNoticeDetToCreateTime:str=None) -> str:  # 定义工具函数
    ...
    Args:
        ...
        samOrderNoticeDetFromCreateTime: 开始时间，格式为YYYY-%m-DD %H:%M:%S
        
        samOrderNoticeDetToCreateTime: 束时间，格式为YYYY-%m-DD %H:%M:%S
