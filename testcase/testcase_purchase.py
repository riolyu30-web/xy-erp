...
def PURCHASE_REQUISITION_DETAIL_test(access_token: str):  # 定义测试函数
    """
    ...
    purRequDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def PROCUREMENT_ORDER_DETAIL_test(access_token: str):  # 定义测试函数
    ...
    procOrderDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def MAT_INSTORAGE_DET_test(access_token: str):  # 定义测试函数
    ...
    matInstorageDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def SUPP_STATEMENT_DET_test(access_token: str):  # 定义测试函数
    ...
    suppStatementDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
if __name__ == "__main__":
    ...
    PURCHASE_REQUISITION_DETAIL_test(access_token)  # 调用测试函数
    
    PROCUREMENT_ORDER_DETAIL_test(access_token)  # 调用测试函数
    
    MAT_INSTORAGE_DET_test(access_token)  # 调用测试函数
    
    SUPP_STATEMENT_DET_test(access_token)  # 调用测试函数
    
    INVO_ISS_DET_test(access_token)  # 调用测试函数
    
    XY_USERCENTER_ORGANIZATION_test(access_token)  # 调用测试函数
    
    MATERIAL_test(access_token)  # 调用测试函数
