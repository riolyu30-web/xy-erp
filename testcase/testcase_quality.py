...
def CUST_COMP_DET_test(access_token: str):  # 定义测试函数
    """
    ...
    custCompDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def QUALITY_INSPECT_IQC_DET_test(access_token: str):  # 定义测试函数
    ...
    qualityInspectIqcDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def QUALITY_INSPECT_IPQC_DET_test(access_token: str):  # 定义测试函数
    ...
    qualityInspectIpqcDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def QUALITY_INSPECT_OQC_DET_test(access_token: str):  # 定义测试函数
    ...
    qualityInspectOqcDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
def QUALITY_INSPECT_FQC_DET_test(access_token: str):  # 定义测试函数
    ...
    qualityInspectFqcDetToCreateTime = datetime.now().strftime("YYYY-%m-DD %H:%M:%S")
...
if __name__ == "__main__":
    ...
    CUST_COMP_DET_test(access_token)  # 调用测试函数
    
    QUALITY_INSPECT_IQC_DET_test(access_token)  # 调用测试函数
    
    QUALITY_INSPECT_IPQC_DET_test(access_token)  # 调用测试函数
    
    QUALITY_INSPECT_OQC_DET_test(access_token)  # 调用测试函数
    
    QUALITY_INSPECT_FQC_DET_test(access_token)  # 调用测试函数
